...
class DBOperation:
    def __init__(self,database,username='root',password='',port=3306,server="localhost"):
        ...
        try:
            ...
            exit
    #used to execute only select query 
    def FetchRow(self,sql,values=None):
        try:
            ...
            return None
    # insert,update,delete (any query except select)
